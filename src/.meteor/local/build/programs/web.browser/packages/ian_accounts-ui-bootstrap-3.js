...
var ptPT, ptBR, zhCN, zhTW, accountsUIBootstrap3, i, $modal;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                    //
// packages/ian_accounts-ui-bootstrap-3/i18n/ua.i18n.js                                                               //
//                                                                                                                    //
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                      //
i18n.map('ua', {                                                                                                      // 1
...
(function() {                                                                                                         // 1
	...
	Template._loginButtonsLoggedOutAllServices.events({                                                                  // 87
		...
		'click #signup-link': function(event) {                                                                             // 105
			...
			loginButtonsSession.resetMessages();                                                                               // 107
                                                                                                                      // 108
			// store values of fields before swtiching to the signup form                                                      // 109
			var username = trimmedElementValueById('login-username');                                                          // 110
			var email = trimmedElementValueById('login-email');                                                                // 111
			var usernameOrEmail = trimmedElementValueById('login-username-or-email');                                          // 112
			// notably not trimmed. a password could (?) start or end with a space                                             // 113
			var password = elementValueById('login-password');                                                                 // 114
                                                                                                                      // 115
			loginButtonsSession.set('inSignupFlow', true);                                                                     // 116
			loginButtonsSession.set('inForgotPasswordFlow', false);                                                            // 117
                                                                                                                      // 118
			// force the ui to update so that we have the approprate fields to fill in                                         // 119
			Meteor.flush();                                                                                                    // 120
                                                                                                                      // 121
			// update new fields with appropriate defaults                                                                     // 122
			if (username !== null){                                                                                            // 123
				document.getElementById('login-username').value = username;                                                       // 124
			} else if (email !== null){                                                                                        // 125
				document.getElementById('login-email').value = email;                                                             // 126
			} else if (usernameOrEmail !== null){                                                                              // 127
				if (usernameOrEmail.indexOf('@') === -1){                                                                         // 128
					document.getElementById('login-username').value = usernameOrEmail;                                               // 129
				} else {                                                                                                          // 130
					document.getElementById('login-email').value = usernameOrEmail;                                                  // 131
				}                                                                                                                 // 132
			}                                                                                                                  // 133
		},                                                                                                                  // 134
		'click #forgot-password-link': function(event) {                                                                    // 135
			event.stopPropagation();                                                                                           // 136
			loginButtonsSession.resetMessages();                                                                               // 137
                                                                                                                      // 138
			// store values of fields before swtiching to the signup form                                                      // 139
			var email = trimmedElementValueById('login-email');                                                                // 140
			var usernameOrEmail = trimmedElementValueById('login-username-or-email');                                          // 141
                                                                                                                      // 142
			loginButtonsSession.set('inSignupFlow', false);                                                                    // 143
			loginButtonsSession.set('inForgotPasswordFlow', true);                                                             // 144
                                                                                                                      // 145
			// force the ui to update so that we have the approprate fields to fill in                                         // 146
			Meteor.flush();                                                                                                    // 147
			//toggleDropdown();                                                                                                // 148
                                                                                                                      // 149
			// update new fields with appropriate defaults                                                                     // 150
			if (email !== null){                                                                                               // 151
				document.getElementById('forgot-password-email').value = email;                                                   // 152
			} else if (usernameOrEmail !== null){                                                                              // 153
				if (usernameOrEmail.indexOf('@') !== -1){                                                                         // 154
					document.getElementById('forgot-password-email').value = usernameOrEmail;                                        // 155
				}                                                                                                                 // 156
			}                                                                                                                  // 157
		},                                                                                                                  // 158
		'click #back-to-login-link': function(event) {                                                                      // 159
			event.stopPropagation();                                                                                           // 160
			loginButtonsSession.resetMessages();                                                                               // 161
                                                                                                                      // 162
			var username = trimmedElementValueById('login-username');                                                          // 163
			var email = trimmedElementValueById('login-email') || trimmedElementValueById('forgot-password-email'); // Ughh. Standardize on names?
                                                                                                                      // 165
			loginButtonsSession.set('inSignupFlow', false);                                                                    // 166
			loginButtonsSession.set('inForgotPasswordFlow', false);                                                            // 167
                                                                                                                      // 168
			// force the ui to update so that we have the approprate fields to fill in                                         // 169
			Meteor.flush();                                                                                                    // 170
                                                                                                                      // 171
			if (document.getElementById('login-username')){                                                                    // 172
				document.getElementById('login-username').value = username;                                                       // 173
			}                                                                                                                  // 174
			if (document.getElementById('login-email')){                                                                       // 175
				document.getElementById('login-email').value = email;                                                             // 176
			}                                                                                                                  // 177
			// "login-password" is preserved thanks to the preserve-inputs package                                             // 178
			if (document.getElementById('login-username-or-email')){                                                           // 179
				document.getElementById('login-username-or-email').value = email || username;                                     // 180
			}                                                                                                                  // 181
		},                                                                                                                  // 182
		'keypress #login-username, keypress #login-email, keypress #login-username-or-email, keypress #login-password, keypress #login-password-again': function(event) {
			if (event.keyCode === 13){                                                                                         // 184
				loginOrSignup();                                                                                                  // 185
			}                                                                                                                  // 186
		}                                                                                                                   // 187
	});                                                                                                                  // 188
                                                                                                                      // 189
	Template._loginButtonsLoggedOutDropdown.helpers({                                                                    // 190
		forbidClientAccountCreation: function() {                                                                           // 191
			return Accounts._options.forbidClientAccountCreation;                                                              // 192
		}                                                                                                                   // 193
	});                                                                                                                  // 194
                                                                                                                      // 195
	Template._loginButtonsLoggedOutAllServices.helpers({                                                                 // 196
		// additional classes that can be helpful in styling the dropdown                                                   // 197
		additionalClasses: function() {                                                                                     // 198
			if (!Accounts.password) {                                                                                          // 199
				return false;                                                                                                     // 200
			} else {                                                                                                           // 201
				if (loginButtonsSession.get('inSignupFlow')) {                                                                    // 202
					return 'login-form-create-account';                                                                              // 203
				} else if (loginButtonsSession.get('inForgotPasswordFlow')) {                                                     // 204
					return 'login-form-forgot-password';                                                                             // 205
				} else {                                                                                                          // 206
					return 'login-form-sign-in';                                                                                     // 207
				}                                                                                                                 // 208
			}                                                                                                                  // 209
		},                                                                                                                  // 210
                                                                                                                      // 211
		dropdownVisible: function() {                                                                                       // 212
			return loginButtonsSession.get('dropdownVisible');                                                                 // 213
		},                                                                                                                  // 214
                                                                                                                      // 215
		services: function() {                                                                                              // 216
			return Accounts._loginButtons.getLoginServices();                                                                  // 217
		},                                                                                                                  // 218
                                                                                                                      // 219
		isPasswordService: function() {                                                                                     // 220
			return this.name === 'password';                                                                                   // 221
		},                                                                                                                  // 222
                                                                                                                      // 223
		hasOtherServices: function() {                                                                                      // 224
			return Accounts._loginButtons.getLoginServices().length > 1;                                                       // 225
		},                                                                                                                  // 226
                                                                                                                      // 227
		hasPasswordService: function() {                                                                                    // 228
			return Accounts._loginButtons.hasPasswordService();                                                                // 229
		}                                                                                                                   // 230
	});                                                                                                                  // 231
                                                                                                                      // 232
                                                                                                                      // 233
	Template._loginButtonsLoggedOutPasswordService.helpers({                                                             // 234
		fields: function() {                                                                                                // 235
			var loginFields = [{                                                                                               // 236
				fieldName: 'username-or-email',                                                                                   // 237
				fieldLabel: i18n('loginFields.usernameOrEmail'),                                                                  // 238
				visible: function() {                                                                                             // 239
					return _.contains(                                                                                               // 240
						["USERNAME_AND_EMAIL_CONFIRM", "USERNAME_AND_EMAIL", "USERNAME_AND_OPTIONAL_EMAIL"],                            // 241
						Accounts.ui._passwordSignupFields());                                                                           // 242
				}                                                                                                                 // 243
			}, {                                                                                                               // 244
				fieldName: 'username',                                                                                            // 245
				fieldLabel: i18n('loginFields.username'),                                                                         // 246
				visible: function() {                                                                                             // 247
					return Accounts.ui._passwordSignupFields() === "USERNAME_ONLY";                                                  // 248
				}                                                                                                                 // 249
			}, {                                                                                                               // 250
				fieldName: 'email',                                                                                               // 251
				fieldLabel: i18n('loginFields.email'),                                                                            // 252
				inputType: 'email',                                                                                               // 253
				visible: function() {                                                                                             // 254
					return Accounts.ui._passwordSignupFields() === "EMAIL_ONLY";                                                     // 255
				}                                                                                                                 // 256
			}, {                                                                                                               // 257
				fieldName: 'password',                                                                                            // 258
				fieldLabel: i18n('loginFields.password'),                                                                         // 259
				inputType: 'password',                                                                                            // 260
				visible: function() {                                                                                             // 261
					return true;                                                                                                     // 262
				}                                                                                                                 // 263
			}];                                                                                                                // 264
                                                                                                                      // 265
			var signupFields = [{                                                                                              // 266
				fieldName: 'username',                                                                                            // 267
				fieldLabel: i18n('signupFields.username'),                                                                        // 268
				visible: function() {                                                                                             // 269
					return _.contains(                                                                                               // 270
						["USERNAME_AND_EMAIL_CONFIRM", "USERNAME_AND_EMAIL", "USERNAME_AND_OPTIONAL_EMAIL", "USERNAME_ONLY"],           // 271
						Accounts.ui._passwordSignupFields());                                                                           // 272
				}                                                                                                                 // 273
			}, {                                                                                                               // 274
				fieldName: 'email',                                                                                               // 275
				fieldLabel: i18n('signupFields.email'),                                                                           // 276
				inputType: 'email',                                                                                               // 277
				visible: function() {                                                                                             // 278
					return _.contains(                                                                                               // 279
						["USERNAME_AND_EMAIL_CONFIRM", "USERNAME_AND_EMAIL", "EMAIL_ONLY"],                                             // 280
						Accounts.ui._passwordSignupFields());                                                                           // 281
				}                                                                                                                 // 282
			}, {                                                                                                               // 283
				fieldName: 'email',                                                                                               // 284
				fieldLabel: i18n('signupFields.emailOpt'),                                                                        // 285
				inputType: 'email',                                                                                               // 286
				visible: function() {                                                                                             // 287
					return Accounts.ui._passwordSignupFields() === "USERNAME_AND_OPTIONAL_EMAIL";                                    // 288
				}                                                                                                                 // 289
			}, {                                                                                                               // 290
				fieldName: 'password',                                                                                            // 291
				fieldLabel: i18n('signupFields.password'),                                                                        // 292
				inputType: 'password',                                                                                            // 293
				visible: function() {                                                                                             // 294
					return true;                                                                                                     // 295
				}                                                                                                                 // 296
			}, {                                                                                                               // 297
				fieldName: 'password-again',                                                                                      // 298
				fieldLabel: i18n('signupFields.passwordAgain'),                                                                   // 299
				inputType: 'password',                                                                                            // 300
				visible: function() {                                                                                             // 301
					// No need to make users double-enter their password if                                                          // 302
					// they'll necessarily have an email set, since they can use                                                     // 303
					// the "forgot password" flow.                                                                                   // 304
					return _.contains(                                                                                               // 305
						["USERNAME_AND_EMAIL_CONFIRM", "USERNAME_AND_OPTIONAL_EMAIL", "USERNAME_ONLY"],                                 // 306
						Accounts.ui._passwordSignupFields());                                                                           // 307
				}                                                                                                                 // 308
			}];                                                                                                                // 309
                                                                                                                      // 310
			signupFields = signupFields.concat(Accounts.ui._options.extraSignupFields);                                        // 311
                                                                                                                      // 312
			return loginButtonsSession.get('inSignupFlow') ? signupFields : loginFields;                                       // 313
		},                                                                                                                  // 314
                                                                                                                      // 315
		inForgotPasswordFlow: function() {                                                                                  // 316
			return loginButtonsSession.get('inForgotPasswordFlow');                                                            // 317
		},                                                                                                                  // 318
                                                                                                                      // 319
		inLoginFlow: function() {                                                                                           // 320
			return !loginButtonsSession.get('inSignupFlow') && !loginButtonsSession.get('inForgotPasswordFlow');               // 321
		},                                                                                                                  // 322
                                                                                                                      // 323
		inSignupFlow: function() {                                                                                          // 324
			return loginButtonsSession.get('inSignupFlow');                                                                    // 325
		},                                                                                                                  // 326
                                                                                                                      // 327
		showForgotPasswordLink: function() {                                                                                // 328
			return _.contains(                                                                                                 // 329
				["USERNAME_AND_EMAIL_CONFIRM", "USERNAME_AND_EMAIL", "USERNAME_AND_OPTIONAL_EMAIL", "EMAIL_ONLY"],                // 330
				Accounts.ui._passwordSignupFields());                                                                             // 331
		},                                                                                                                  // 332
                                                                                                                      // 333
		showCreateAccountLink: function() {                                                                                 // 334
			return !Accounts._options.forbidClientAccountCreation;                                                             // 335
		}                                                                                                                   // 336
	});                                                                                                                  // 337
                                                                                                                      // 338
	Template._loginButtonsFormField.helpers({                                                                            // 339
		equals: function(a, b) {                                                                                            // 340
			return (a === b);                                                                                                  // 341
		},                                                                                                                  // 342
		inputType: function() {                                                                                             // 343
			return this.inputType || "text";                                                                                   // 344
		},                                                                                                                  // 345
		inputTextual: function() {                                                                                          // 346
			return !_.contains(["radio", "checkbox", "select"], this.inputType);                                               // 347
		}                                                                                                                   // 348
	});                                                                                                                  // 349
                                                                                                                      // 350
	//                                                                                                                   // 351
	// loginButtonsChangePassword template                                                                               // 352
	//                                                                                                                   // 353
	Template._loginButtonsChangePassword.events({                                                                        // 354
		'keypress #login-old-password, keypress #login-password, keypress #login-password-again': function(event) {         // 355
			if (event.keyCode === 13){                                                                                         // 356
				changePassword();                                                                                                 // 357
			}                                                                                                                  // 358
		},                                                                                                                  // 359
		'click #login-buttons-do-change-password': function(event) {                                                        // 360
			event.stopPropagation();                                                                                           // 361
			changePassword();                                                                                                  // 362
		},                                                                                                                  // 363
		'click #login-buttons-cancel-change-password': function(event) {                                                    // 364
			event.stopPropagation();                                                                                           // 365
			loginButtonsSession.resetMessages();                                                                               // 366
			Accounts._loginButtonsSession.set('inChangePasswordFlow', false);                                                  // 367
			Meteor.flush();                                                                                                    // 368
		}                                                                                                                   // 369
	});                                                                                                                  // 370
                                                                                                                      // 371
	Template._loginButtonsChangePassword.helpers({                                                                       // 372
		fields: function() {                                                                                                // 373
			return [{                                                                                                          // 374
				fieldName: 'old-password',                                                                                        // 375
				fieldLabel: i18n('changePasswordFields.currentPassword'),                                                         // 376
				inputType: 'password',                                                                                            // 377
				visible: function() {                                                                                             // 378
					return true;                                                                                                     // 379
				}                                                                                                                 // 380
			}, {                                                                                                               // 381
				fieldName: 'password',                                                                                            // 382
				fieldLabel: i18n('changePasswordFields.newPassword'),                                                             // 383
				inputType: 'password',                                                                                            // 384
				visible: function() {                                                                                             // 385
					return true;                                                                                                     // 386
				}                                                                                                                 // 387
			}, {                                                                                                               // 388
				fieldName: 'password-again',                                                                                      // 389
				fieldLabel: i18n('changePasswordFields.newPasswordAgain'),                                                        // 390
				inputType: 'password',                                                                                            // 391
				visible: function() {                                                                                             // 392
					// No need to make users double-enter their password if                                                          // 393
					// they'll necessarily have an email set, since they can use                                                     // 394
					// the "forgot password" flow.                                                                                   // 395
					return _.contains(                                                                                               // 396
						["USERNAME_AND_OPTIONAL_EMAIL", "USERNAME_ONLY"],                                                               // 397
						Accounts.ui._passwordSignupFields());                                                                           // 398
				}                                                                                                                 // 399
			}];                                                                                                                // 400
		}                                                                                                                   // 401
	});                                                                                                                  // 402
	...
	//                                                                                                                   // 406
                                                                                                                      // 407
	var elementValueById = function(id) {                                                                                // 408
		var element = document.getElementById(id);                                                                          // 409
		if (!element){                                                                                                      // 410
			return null;                                                                                                       // 411
		} else {                                                                                                            // 412
			return element.value;                                                                                              // 413
		}                                                                                                                   // 414
	};                                                                                                                   // 415
                                                                                                                      // 416
	var elementValueByIdForRadio = function(fieldIdPrefix, radioOptions) {                                               // 417
		var value = null;                                                                                                   // 418
		for (i in radioOptions) {                                                                                           // 419
			var element = document.getElementById(fieldIdPrefix + '-' + radioOptions[i].id);                                   // 420
			if (element && element.checked){                                                                                   // 421
				value =  element.value;                                                                                           // 422
			}                                                                                                                  // 423
		}                                                                                                                   // 424
		return value;                                                                                                       // 425
	};                                                                                                                   // 426
                                                                                                                      // 427
	var elementValueByIdForCheckbox = function(id) {                                                                     // 428
		var element = document.getElementById(id);                                                                          // 429
		return element.checked;                                                                                             // 430
	};                                                                                                                   // 431
                                                                                                                      // 432
	var trimmedElementValueById = function(id) {                                                                         // 433
		var element = document.getElementById(id);                                                                          // 434
		if (!element){                                                                                                      // 435
			return null;                                                                                                       // 436
		} else {                                                                                                            // 437
			return element.value.replace(/^\s*|\s*$/g, ""); // trim;                                                           // 438
		}                                                                                                                   // 439
	};                                                                                                                   // 440
                                                                                                                      // 441
	var loginOrSignup = function() {                                                                                     // 442
		if (loginButtonsSession.get('inSignupFlow')){                                                                       // 443
			signup();                                                                                                          // 444
		} else {                                                                                                            // 445
			login();                                                                                                           // 446
		}                                                                                                                   // 447
                                                                                                                      ...
                                                                                                                      // 449
	var login = function() {                                                                                             // 450
		loginButtonsSession.resetMessages();                                                                                // 451
                                                                                                                      // 452
		var username = trimmedElementValueById('login-username');                                                           // 453
		if (username && Accounts.ui._options.forceUsernameLowercase) {                                                      // 454
			username = username.toLowerCase();                                                                                 // 455
		}                                                                                                                   // 456
		var email = trimmedElementValueById('login-email');                                                                 // 457
		if (email && Accounts.ui._options.forceEmailLowercase) {                                                            // 458
			email = email.toLowerCase();                                                                                       // 459
		}                                                                                                                   // 460
		var usernameOrEmail = trimmedElementValueById('login-username-or-email');                                           // 461
		if (usernameOrEmail && Accounts.ui._options.forceEmailLowercase && Accounts.ui._options.forceUsernameLowercase) {   // 462
			usernameOrEmail = usernameOrEmail.toLowerCase();                                                                   // 463
		}                                                                                                                   // 464
                                                                                                                      // 465
		// notably not trimmed. a password could (?) start or end with a space                                              // 466
		var password = elementValueById('login-password');                                                                  // 467
		if (password && Accounts.ui._options.forcePasswordLowercase) {                                                      // 468
			password = password.toLowerCase();                                                                                 // 469
		}                                                                                                                   // 470
                                                                                                                      // 471
		var loginSelector;                                                                                                  // 472
		if (username !== null) {                                                                                            // 473
			if (!Accounts._loginButtons.validateUsername(username)){                                                           // 474
				return;                                                                                                           // 475
			} else {                                                                                                           // 476
				loginSelector = {                                                                                                 // 477
					username: username                                                                                               // 478
				};                                                                                                                // 479
			}                                                                                                                  // 480
		} else if (email !== null) {                                                                                        // 481
			if (!Accounts._loginButtons.validateEmail(email)){                                                                 // 482
				return;                                                                                                           // 483
			} else {                                                                                                           // 484
				loginSelector = {                                                                                                 // 485
					email: email                                                                                                     // 486
		...
		} else if (usernameOrEmail !== null) {                                                                              // 489
			// XXX not sure how we should validate this. but this seems good enough (for now),                                 // 490
			// since an email must have at least 3 characters anyways                                                          // 491
			if (!Accounts._loginButtons.validateUsername(usernameOrEmail)){                                                    // 492
				return;                                                                                                           // 493
			} else {                                                                                                           // 494
				loginSelector = usernameOrEmail;                                                                                  // 495
			}                                                                                                                  // 496
		} else {                                                                                                            // 497
			throw new Error("Unexpected -- no element to use as a login user selector");                                       // 498
		}                                                                                                                   // 499
                                                                                                                      // 500
		Meteor.loginWithPassword(loginSelector, password, function(error, result) {                                         // 501
			if (error) {                                                                                                       // 502
				if (error.reason == 'User not found'){                                                                            // 503
					loginButtonsSession.errorMessage(i18n('errorMessages.userNotFound'))                                             // 504
				} else if (error.reason == 'Incorrect password'){                                                                 // 505
					loginButtonsSession.errorMessage(i18n('errorMessages.incorrectPassword'))                                        // 506
				} else {                                                                                                          // 507
					loginButtonsSession.errorMessage(error.reason || "Unknown error");                                               // 508
				}                                                                                                                 // 509
			} else {                                                                                                           // 510
				loginButtonsSession.closeDropdown();                                                                              // 511
			}                                                                                                                  // 512
		});                                                                                                                 // 513
	};                                                                                                                   // 514
                                                                                                                      // 515
	var toggleDropdown = function() {                                                                                    // 516
		$("#login-dropdown-list").toggleClass("open");                                                                      // 517
	}                                                                                                                    // 518
                                                                                                                      // 519
	var focusInput = function() {                                                                                        // 520
		setTimeout(function() {                                                                                             // 521
			$("#login-dropdown-list input").first().focus();                                                                   // 522
		}, 0);                                                                                                              // 523
	};                                                                                                                   // 524
                                                                                                                      // 525
	var signup = function() {                                                                                            // 526
		loginButtonsSession.resetMessages();                                                                                // 527
                                                                                                                      // 528
		// to be passed to Accounts.createUser                                                                              // 529
		var options = {};                                                                                                   // 530
		if(typeof accountsUIBootstrap3.setCustomSignupOptions === 'function') {                                             // 531
			options = accountsUIBootstrap3.setCustomSignupOptions();                                                           // 532
			if (!(options instanceof Object)){ options = {}; }                                                                 // 533
		}                                                                                                                   // 534
                                                                                                                      // 535
		var username = trimmedElementValueById('login-username');                                                           // 536
		if (username && Accounts.ui._options.forceUsernameLowercase) {                                                      // 537
			username = username.toLowerCase();                                                                                 // 538
		}                                                                                                                   // 539
		if (username !== null) {                                                                                            // 540
			if (!Accounts._loginButtons.validateUsername(username)){                                                           // 541
				return;                                                                                                           // 542
			} else {                                                                                                           // 543
				options.username = username;                                                                                      // 544
			}                                                                                                                  // 545
		}                                                                                                                   // 546
                                                                                                                      // 547
		var email = trimmedElementValueById('login-email');                                                                 // 548
		if (email && Accounts.ui._options.forceEmailLowercase) {                                                            // 549
			email = email.toLowerCase();                                                                                       // 550
		}                                                                                                                   // 551
		if (email !== null) {                                                                                               // 552
			if (!Accounts._loginButtons.validateEmail(email)){                                                                 // 553
				return;                                                                                                           // 554
			} else {                                                                                                           // 555
				options.email = email;                                                                                            // 556
			}                                                                                                                  // 557
		}                                                                                                                   // 558
                                                                                                                      // 559
		// notably not trimmed. a password could (?) start or end with a space                                              // 560
		var password = elementValueById('login-password');                                                                  // 561
		if (password && Accounts.ui._options.forcePasswordLowercase) {                                                      // 562
			password = password.toLowerCase();                                                                                 // 563
		}                                                                                                                   // 564
		if (!Accounts._loginButtons.validatePassword(password)){                                                            // 565
			return;                                                                                                            // 566
		} else {                                                                                                            // 567
			options.password = password;                                                                                       // 568
		}                                                                                                                   // 569
                                                                                                                      // 570
		if (!matchPasswordAgainIfPresent()){                                                                                // 571
			return;                                                                                                            // 572
		}                                                                                                                   // 573
                                                                                                                      // 574
		// prepare the profile object                                                                                       // 575
		// it could have already been set through setCustomSignupOptions                                                    // 576
		if (!(options.profile instanceof Object)){                                                                          // 577
			options.profile = {};                                                                                              // 578
		}                                                                                                                   // 579
                                                                                                                      // 580
		// define a proxy function to allow extraSignupFields set error messages                                            // 581
		var errorFunction = function(errorMessage) {                                                                        // 582
			Accounts._loginButtonsSession.errorMessage(errorMessage);                                                          // 583
		};                                                                                                                  // 584
                                                                                                                      // 585
		var invalidExtraSignupFields = false;                                                                               // 586
		// parse extraSignupFields to populate account's profile data                                                       // 587
		_.each(Accounts.ui._options.extraSignupFields, function(field, index) {                                             // 588
						var value = null;                                                                                               // 589
						var elementIdPrefix = 'login-';                                                                                 // 590
                                                                                                                      // 591
						if (field.inputType === 'radio') {                                                                              // 592
							value = elementValueByIdForRadio(elementIdPrefix + field.fieldName, field.data);                               // 593
						} else if (field.inputType === 'checkbox') {                                                                    // 594
							value = elementValueByIdForCheckbox(elementIdPrefix + field.fieldName);                                        // 595
						} else {                                                                                                        // 596
							value = elementValueById(elementIdPrefix + field.fieldName);                                                   // 597
						}                                                                                                               // 598
                                                                                                                      // 599
			if (typeof field.validate === 'function') {                                                                        // 600
				if (field.validate(value, errorFunction)) {                                                                       // 601
					if (typeof field.saveToProfile !== 'undefined' && !field.saveToProfile){                                         // 602
						options[field.fieldName] = value;                                                                               // 603
					} else {                                                                                                         // 604
						options.profile[field.fieldName] = value;                                                                       // 605
					}                                                                                                                // 606
				} else {                                                                                                          // 607
					invalidExtraSignupFields = true;                                                                                 // 608
				}                                                                                                                 // 609
			} else {                                                                                                           // 610
				options.profile[field.fieldName] = value;                                                                         // 611
			}                                                                                                                  // 612
		});                                                                                                                 // 613
                                                                                                                      // 614
		if (invalidExtraSignupFields){                                                                                      // 615
			return;                                                                                                            // 616
		}                                                                                                                   // 617
                                                                                                                      // 618
		Accounts.createUser(options, function(error) {                                                                      // 619
			if (error) {                                                                                                       // 620
				if (error.reason == 'Signups forbidden'){                                                                         // 621
					loginButtonsSession.errorMessage(i18n('errorMessages.signupsForbidden'))                                         // 622
				} else {                                                                                                          // 623
					loginButtonsSession.errorMessage(error.reason || "Unknown error");                                               // 624
				}                                                                                                                 // 625
			} else {                                                                                                           // 626
				loginButtonsSession.closeDropdown();                                                                              // 627
			}                                                                                                                  // 628
		});                                                                                                                 // 629
	};                                                                                                                   // 630
                                                                                                                      // 631
	var forgotPassword = function() {                                                                                    // 632
		loginButtonsSession.resetMessages();                                                                                // 633
                                                                                                                      // 634
		var email = trimmedElementValueById("forgot-password-email");                                                       // 635
		if (email.indexOf('@') !== -1) {                                                                                    // 636
			Accounts.forgotPassword({                                                                                          // 637
				email: email                                                                                                      // 638
			}, function(error) {                                                                                               // 639
				if (error) {                                                                                                      // 640
					if (error.reason == 'User not found'){                                                                           // 641
						loginButtonsSession.errorMessage(i18n('errorMessages.userNotFound'))                                            // 642
					} else {                                                                                                         // 643
						loginButtonsSession.errorMessage(error.reason || "Unknown error");                                              // 644
					}                                                                                                                // 645
				} else {                                                                                                          // 646
					loginButtonsSession.infoMessage(i18n('infoMessages.emailSent'));                                                 // 647
				}                                                                                                                 // 648
			});                                                                                                                // 649
		} else {                                                                                                            // 650
			loginButtonsSession.errorMessage(i18n('forgotPasswordForm.invalidEmail'));                                         // 651
		}                                                                                                                   // 652
	};                                                                                                                   // 653
	var changePassword = function() {                                                                                    // 654
		loginButtonsSession.resetMessages();                                                                                // 655
		// notably not trimmed. a password could (?) start or end with a space                                              // 656
		var oldPassword = elementValueById('login-old-password');                                                           // 657
		// notably not trimmed. a password could (?) start or end with a space                                              // 658
		var password = elementValueById('login-password');                                                                  // 659
                                                                                                                      // 660
		if (password == oldPassword) {                                                                                      // 661
			loginButtonsSession.errorMessage(i18n('errorMessages.newPasswordSameAsOld'));                                      // 662
			return;                                                                                                            // 663
		}                                                                                                                   // 664
                                                                                                                      // 665
		if (!Accounts._loginButtons.validatePassword(password)){                                                            // 666
			return;                                                                                                            // 667
		}                                                                                                                   // 668
                                                                                                                      // 669
		if (!matchPasswordAgainIfPresent()){                                                                                // 670
			return;                                                                                                            // 671
		}                                                                                                                   // 672
                                                                                                                      // 673
		Accounts.changePassword(oldPassword, password, function(error) {                                                    // 674
			if (error) {                                                                                                       // 675
				if (error.reason == 'Incorrect password'){                                                                        // 676
					loginButtonsSession.errorMessage(i18n('errorMessages.incorrectPassword'))                                        // 677
				} else {                                                                                                          // 678
					loginButtonsSession.errorMessage(error.reason || "Unknown error");                                               // 679
				}                                                                                                                 // 680
			} else {                                                                                                           // 681
				loginButtonsSession.infoMessage(i18n('infoMessages.passwordChanged'));                                            // 682
                                                                                                                      // 683
				// wait 3 seconds, then expire the msg                                                                            // 684
				Meteor.setTimeout(function() {                                                                                    // 685
					loginButtonsSession.resetMessages();                                                                             // 686
				}, 3000);                                                                                                         // 687
			}                                                                                                                  // 688
		});                                                                                                                 // 689
	};                                                                                                                   // 690
                                                                                                                      // 691
	var matchPasswordAgainIfPresent = function() {                                                                       // 692
		// notably not trimmed. a password could (?) start or end with a space                                              // 693
		var passwordAgain = elementValueById('login-password-again');                                                       // 694
		if (passwordAgain !== null) {                                                                                       // 695
			// notably not trimmed. a password could (?) start or end with a space                                             // 696
			var password = elementValueById('login-password');                                                                 // 697
			if (password !== passwordAgain) {                                                                                  // 698
				loginButtonsSession.errorMessage(i18n('errorMessages.passwordsDontMatch'));                                       // 699
				return false;                                                                                                     // 700
			}                                                                                                                  // 701
		}                                                                                                                   // 702
		return true;                                                                                                        // 703
